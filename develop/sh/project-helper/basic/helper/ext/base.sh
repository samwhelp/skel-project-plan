...
base_var_dump () {
	...
	util_debug_echo "THE_MASTER_ASSET_PORT_DIR_NAME=${THE_MASTER_ASSET_PORT_DIR_NAME}"
	util_debug_echo "THE_MASTER_ASSET_PORT_DIR_PATH=${THE_MASTER_ASSET_PORT_DIR_PATH}"
	util_debug_echo

	util_debug_echo "THE_MASTER_ASSET_PROFILE_DIR_NAME=${THE_MASTER_ASSET_PROFILE_DIR_NAME}"
	util_debug_echo "THE_MASTER_ASSET_PROFILE_DIR_PATH=${THE_MASTER_ASSET_PROFILE_DIR_PATH}"
	util_debug_echo
