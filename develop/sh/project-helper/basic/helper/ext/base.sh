...
base_var_init () {
	...
	THE_MASTER_PORT_DIR_NAME="port"
	THE_MASTER_PORT_DIR_PATH="${THE_MASTER_DIR_PATH}/${THE_MASTER_PORT_DIR_NAME}"

	THE_MASTER_PROFILE_DIR_NAME="profile"
	THE_MASTER_PROFILE_DIR_PATH="${THE_MASTER_DIR_PATH}/${THE_MASTER_PROFILE_DIR_NAME}"
...
base_var_dump () {
	...
	util_debug_echo "THE_MASTER_PORT_DIR_NAME=${THE_MASTER_PORT_DIR_NAME}"
	util_debug_echo "THE_MASTER_PORT_DIR_PATH=${THE_MASTER_PORT_DIR_PATH}"
	util_debug_echo

	util_debug_echo "THE_MASTER_PROFILE_DIR_NAME=${THE_MASTER_PROFILE_DIR_NAME}"
	util_debug_echo "THE_MASTER_PROFILE_DIR_PATH=${THE_MASTER_PROFILE_DIR_PATH}"
	util_debug_echo
