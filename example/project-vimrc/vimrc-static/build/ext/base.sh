...
base_var_dump () {
	...
	util_debug_echo "THE_BOOT_DIR_NAME=$THE_BOOT_DIR_NAME"
	util_debug_echo "THE_BOOT_DIR_PATH=$THE_BOOT_DIR_PATH"

	util_debug_echo "THE_CONF_DIR_NAME=$THE_CONF_DIR_NAME"
	util_debug_echo "THE_CONF_DIR_PATH=$THE_CONF_DIR_PATH"
